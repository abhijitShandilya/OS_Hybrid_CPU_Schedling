...
public class Priority {
 public static void runPriority(int[] procArr, int[] procBurst, int[] procPri)
 {      int n;
 System.out.println("\n\n ============== Priority Scheduling Algorithm Output ============== ");
       n = procArr.length;
       int proc[][] = new int[n + 1][5];//proc[][0] is the AT array,[][1] - BT,[][2] - WT,[][3] - TT, [][4] - Priority
       for(int i = 1; i <= n; i++)
       {
      ...
      proc[i][4] = procPri[i-1]; //Integer.parseInt(br.readLine());
     }
